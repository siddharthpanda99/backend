...
def _authz_router():
    from app.modules.authorization.routes.authz_router import router as authz_full_router
...
def _knowledge_hub_entries(api_prefix: str) -> list:
    ...
    return [
        {"router": sources_router,     "prefix": "", "tags": ["Knowledge Hub — Sources"],   "auth": True},
        {"router": pipelines_router,   "prefix": "", "tags": ["Knowledge Hub — Ingestion"], "auth": True},
        {"router": packets_router,     "prefix": "", "tags": ["Knowledge Hub — Packets"],   "auth": True},
        {"router": kh_projects_router, "prefix": "", "tags": ["Knowledge Hub — Projects"],  "auth": True},
        {"router": streaming_router,   "prefix": "", "tags": ["Knowledge Hub — Streaming"], "auth": True},
    ]
...
def register_routers(app: FastAPI, api_prefix: str, global_deps: List[Any]) -> None:
    ...
    from app.modules.workflows.routes.failure_analysis import router as failure_analysis_router
    ...
    ROUTER_DEFINITIONS = [
        ...
        {"router": auth_router,            "prefix": "/auth",                     "tags": ["Authentication"],           "auth": False},
        {"router": sessions_router,        "prefix": "/sessions",                 "tags": ["Sessions"],                 "auth": True},
        # ── Authorization ─────────────────────────────────────────
        {"router": roles_router,           "prefix": "/roles",                    "tags": ["Roles"],                    "auth": True},
        {"router": permissions_router,     "prefix": "/permissions",              "tags": ["Permissions"],              "auth": True},
        {"router": users_router,           "prefix": "/users",                    "tags": ["Users"],                    "auth": True},
        {"router": projects_router,        "prefix": "/projects",                 "tags": ["Projects"],                 "auth": True},
        # ── Hooks / Webhooks ───────────────────────────────────────
        {"router": hooks_router,           "prefix": "/hooks",                    "tags": ["Hooks"],                    "auth": True},
        {"router": webhooks_router,        "prefix": "/webhooks",                 "tags": ["Webhook Manager"],          "auth": True},
        # ── App Builder ────────────────────────────────────────────
        {"router": forms_router,           "prefix": "/forms",                    "tags": ["Form Builder"],             "auth": True},
        {"router": features_router,        "prefix": "/features",                 "tags": ["Feature Picker"],           "auth": True},
        {"router": connection_health_router, "prefix": "",                        "tags": ["Connection Health"],        "auth": True},
        {"router": ecosystem_router,       "prefix": "/ecosystem",                "tags": ["App Ecosystem"],            "auth": True},
        {"router": builder_router,         "prefix": "",                          "tags": ["UI Builder"],               "auth": True},
        {"router": schema_router,          "prefix": "/schema",                   "tags": ["Schema Builder"],           "auth": True},
        # ── Entities & Orchestration ───────────────────────────────
        {"router": entities_router,        "prefix": "/entities/registry",        "tags": ["Entities Registry"],        "auth": True},
        {"router": entity_instances_router,"prefix": "/instances",                "tags": ["Entity Instances"],         "auth": True},
        {"router": agents_router,          "prefix": "/agents",                   "tags": ["Agents (Management)"],      "auth": True},
        {"router": pipeline_router,        "prefix": "/agents/pipelines",         "tags": ["Pipelines"],                "auth": True},
        {"router": policy_router,          "prefix": "/agents",                   "tags": ["Policy & Multi-Agent"],     "auth": True},
        # ── Workflows ─────────────────────────────────────────────
        {"router": workflows_router,       "prefix": "/workflows",                "tags": ["Workflows"],                "auth": True},
        {"router": collaboration_router,   "prefix": "/workflows",                "tags": ["Workflow Collaboration"],   "auth": True},
        {"router": observability_router,   "prefix": "/workflows/observability",  "tags": ["Workflow Observability"],   "auth": True},
        {"router": workflow_configs_router,"prefix": "/workflow-configs",         "tags": ["Workflow Configs"],         "auth": True},
        {"router": failure_analysis_router,"prefix": "/workflows",                "tags": ["Workflow Failure Analysis"],"auth": True},
        {"router": combinatorial_router,   "prefix": "/workflows/combinatorial",  "tags": ["Workflow Combinatorial"],   "auth": True},
        # ── Tools & Models ─────────────────────────────────────────
        {"router": tools_router,           "prefix": "/tools",                    "tags": ["Tools"],                    "auth": True},
        {"router": models_router,          "prefix": "/models",                   "tags": ["Models Hub"],               "auth": True},
        {"router": external_models_router, "prefix": "/models/external",          "tags": ["External Models Discovery"],"auth": True},
        {"router": sd_models_router,       "prefix": "",                          "tags": ["SD Models"],                "auth": True},
        # ── Vision & Media ─────────────────────────────────────────
        {"router": sam3_router,            "prefix": "/sam3",                     "tags": ["SAM3 Segmentation"],        "auth": True},
        {"router": vision_router,          "prefix": "/vision",                   "tags": ["Vision"],                   "auth": True},
        {"router": collage_router,         "prefix": "/collage",                  "tags": ["Collage & Sticker"],        "auth": True},
        {"router": filters_router,         "prefix": "/filters",                  "tags": ["Filters"],                  "auth": True},
        {"router": wildcards_router,       "prefix": "/vision",                   "tags": ["Wildcards"],                "auth": True},
        {"router": prompts_router,         "prefix": "/prompts",                  "tags": ["Prompts"],                  "auth": True},
        {"router": audio_router,           "prefix": "/audio",                    "tags": ["Audio & TTS"],              "auth": True},
        # ── Nodes ─────────────────────────────────────────────────
        {"router": nodes_router,           "prefix": "",                          "tags": ["Nodes"],                    "auth": True},
        # ── Memory ─────────────────────────────────────────────────
        {"router": cognitive_memory_router,"prefix": "/memory",                   "tags": ["Memory"],                   "auth": True},
        {"router": memories_router,        "prefix": "/memories",                 "tags": ["Memories"],                 "auth": True},
        {"router": vectorstores_router,    "prefix": "",                          "tags": ["Vector Stores"],            "auth": True},
        # ── Data & Storage ─────────────────────────────────────────
        {"router": data_forge_router,      "prefix": "/data-forge",               "tags": ["DataForge Simulation"],     "auth": True},
        {"router": grid_router,            "prefix": "/grid",                     "tags": ["Grid Customization Persistence"], "auth": True},
        {"router": dip_ingestion_router,   "prefix": "",                          "tags": ["dip/ingestion"],            "auth": True},
        {"router": dip_pipeline_router,    "prefix": "",                          "tags": ["dip/pipeline"],             "auth": True},
        {"router": dip_rag_router,         "prefix": "",                          "tags": ["dip/rag"],                  "auth": True},
        {"router": dip_kg_router,          "prefix": "",                          "tags": ["dip/kg"],                   "auth": True},
        {"router": dip_storage_router,     "prefix": "",                          "tags": ["dip/storage"],              "auth": True},
        {"router": dip_embeddings_router,  "prefix": "",                          "tags": ["dip/embeddings"],           "auth": True},
        # ── Plugins & Connectors ───────────────────────────────────
        {"router": plugins_router,         "prefix": "/plugins",                  "tags": ["Plugin Management"],        "auth": True},
        {"router": plugin_router,          "prefix": "",                          "tags": ["Plugins"],                  "auth": True},
        {"router": connector_router,       "prefix": "",                          "tags": ["Connectors"],               "auth": True},
        {"router": connection_router,      "prefix": "",                          "tags": ["Connections"],              "auth": True},
        {"router": connectors_mcp_router,  "prefix": "",                          "tags": ["MCP-Connectors"],           "auth": True},
        {"router": mcp_router,             "prefix": "/mcp",                      "tags": ["MCP Ecosystem"],            "auth": True},
        # ── Configs & Settings ─────────────────────────────────────
        {"router": configs_router,         "prefix": "",                          "tags": ["Configs"],                  "auth": True},
        {"router": settings_router,        "prefix": "",                          "tags": ["Settings"],                 "auth": True},
        {"router": keys_router,            "prefix": "",                          "tags": ["Keys Management"],          "auth": True},
        {"router": proxy_router,           "prefix": "",                          "tags": ["Proxy Routing"],            "auth": True},
        {"router": system_router,          "prefix": "",                          "tags": ["System"],                   "auth": True},
        # ── Integration & Events ───────────────────────────────────
        {"router": integration_router,     "prefix": "",                          "tags": ["integration"],              "auth": True},
        {"router": notification_router,    "prefix": "",                          "tags": ["notifications"],            "auth": True},
        # ── Background & Scheduling ────────────────────────────────
        {"router": scheduler_router,       "prefix": "",                          "tags": ["scheduler"],                "auth": True},
        {"router": sd_news_router,         "prefix": "",                          "tags": ["sd-news"],                  "auth": True},
        # ── Dashboard / Analytics ──────────────────────────────────
        {"router": dashboard_router,       "prefix": "/dashboard",                "tags": ["dashboard"],                "auth": True},
        # ── External Apps ──────────────────────────────────────────
        {"router": ext_apps_router,        "prefix": "",                          "tags": ["Ext-Apps"],                 "auth": True},
        # ── File Browser ───────────────────────────────────────────
        {"router": file_browser_router,    "prefix": "",                          "tags": ["file-browser"],             "auth": True},
        {"router": macro_router,           "prefix": "/file-browser",             "tags": ["macros"],                   "auth": True},
        # ── Marketplace & Graph ────────────────────────────────────
        {"router": marketplace_router,     "prefix": "/marketplace",              "tags": ["Marketplace"],              "auth": True},
        {"router": graph_router,           "prefix": "/graph",                    "tags": ["Graph"],                    "auth": True},
        # ── Dev & Debug ────────────────────────────────────────────
        {"router": debug_router,           "prefix": "/debug",                    "tags": ["Debug Simulator"],          "auth": True},
        {"router": experiments_router,     "prefix": "/experiments",              "tags": ["Experiments"],              "auth": True},
        # ── DAW ────────────────────────────────────────────────────
        ...
        {"router": _knowledge_router(),    "prefix": "",                          "tags": ["Knowledge Engine"],         "auth": True},
        {"router": _governance_router(),   "prefix": "/governance",               "tags": ["Agent Governance"],         "auth": True},
        {"router": _obs_admin_router(),    "prefix": "",                          "tags": ["Observability Admin"],      "auth": True},
        {"router": _docs_router(),         "prefix": "",                          "tags": ["Documentation"],            "auth": True},
        # ── Knowledge Hub ──────────────────────────────────────────
        *_knowledge_hub_entries(api_prefix),
        # ── Agentic RBAC ───────────────────────────────────────────
        {"router": _authz_router(),        "prefix": "/authz",                    "tags": ["Authorization — Agentic RBAC"], "auth": True},
        # ── Team ───────────────────────────────────────────────────
