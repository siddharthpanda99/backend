...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: list[str] = config.get_list("Backend", "cors_origins", ["http://localhost:3000", "http://localhost:5173"])
    ...
    # Security
    SECRET_KEY: str = config.get("Keys", "secret_key", "09d25e094faa6ca2556c818166b7a9563b93f7099f6f0f4caa6cf63b88e8d3e7")
    ALGORITHM: str = "HS256"
    ...
    POSTGRES_PASSWORD: str = config.get("Database", "postgres_password", "nexus_password")
