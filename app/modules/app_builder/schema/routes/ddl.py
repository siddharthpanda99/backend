...
from common_lib.modules.app_builder.schema import (
    SchemaService, SchemaTableRecord, SchemaRelationshipRecord,
...
def _generate_ddl_for_table(
    ...
    for col in (table.columns or []):
        ...
        if col.get("default") is not None:
            ...
            if dialect == "sqlite" and default_val.lower() == "now()":
...
async def generate_ddl(
    ...
    for table in tables:
        ...
        table_rels, _ = service.list_relationships(
            db, schema_id=table.schema_id, source_table_id=table.id, limit=1000
        )
