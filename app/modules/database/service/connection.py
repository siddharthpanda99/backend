...
def init_db():
    ...
    from common_lib.modules.rbac.models import Role, Permission, RolePermission
    from common_lib.modules.projects.models import Project, ProjectModule
    from app.modules.grid.models import GridConfig
    from app.modules.workflows.models.observability import (
        WorkflowExecution,
        WorkflowEvent,
    )
