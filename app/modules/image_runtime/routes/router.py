"""Image Runtime module API routes — Pipeline managers, VRAM, caching, LoRA, scheduler.

Thin routing layer that delegates to common_lib.modules.image_runtime services.
"""
